...
let imgbox = document.querySelector(".diceimg");
        ...
        imgbox.setAttribute("src", "assets/letsplay.png");
...
p1rbtn.addEventListener('click',function(){
   ...
   trnbox.textContent = "Now player 2 turn";
    ...
    if (dicenum == 1)
    {
        imgbox.setAttribute("src", "assets/dice1.png");
    }

  else if (dicenum == 2)
    {
        imgbox.setAttribute("src", "assets/dice2.png");
    }

  else if (dicenum == 3)
    {
        imgbox.setAttribute("src", "assets/dice3.png");
    }

  else if (dicenum == 4)
    {
        imgbox.setAttribute("src", "assets/dice4.png");
    }

  else if (dicenum == 5)
    {
        imgbox.setAttribute("src", "assets/dice5.png");

    }

  else if (dicenum == 6)
    {
        imgbox.setAttribute("src", "assets/dice6.png");
    }
if (player1scr >= 30)
{
    p1rbtn.disabled = true;
...
rstbtn.addEventListener('click', function () {
    ...
    imgbox.setAttribute("src", "asssets/letsplay.png");
    imgbox.setAttribute("style", "height:100px");
